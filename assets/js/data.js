...
const FTDMeshData = {
  ...
  enclosures: [
    ...
    },
    {
      ...
      pricePen: 75,
      image: "./images/carcasas/meshtac-tactical-case.jpg",
      badges: ["Táctica", "Heltec V3/V4/T114", "Campo"],
      compatible: ["Heltec V3", "Heltec V4", "Heltec T114"],
      material: "PLA / PETG",
      color: "Verde militar / Negro",
      printTime: "~6h",
      designer: "MakerWorld Community",
      source: "MakerWorld",
      makerworld: "https://makerworld.com/es/models/1418298",
      description: "Carcasa táctica multicompatible con placa frontal personalizable. Diseño robusto para campo, cabe en go-bag y se puede montar en correa de mochila. Compatible con Heltec V3, V4 y T114.",
      stock: true,
      featured: true
    },
    {
      ...
      pricePen: 85,
      image: "./images/carcasas/heltec-v3-feature-case.jpg",
      badges: ["GPS", "BME280", "Encoder", "3000mAh"],
      compatible: ["Heltec LoRa32 V3"],
      material: "PLA",
      color: "Azul / Negro",
      printTime: "~8h",
      designer: "MakerWorld Community",
      source: "MakerWorld",
      makerworld: "https://makerworld.com/es/models/1636582",
      description: "Carcasa completa para Heltec V3 con espacio para GPS NEO-6M, sensor BME280 (temp/humedad/presión), encoder rotativo EC11, motor vibrador, buzzer y batería LiPo 3000mAh. Incluye guía de cableado.",
      stock: true,
      featured: true
    },
    {
      ...
      pricePen: 45,
      image: "./images/carcasas/h1-minimal-case.jpg",
      badges: ["Minimal", "Heltec V3", "Snap-fit", "22g"],
      compatible: ["Heltec V3 (LoRa32 V3)"],
      material: "PLA mate",
      color: "Negro mate / Gris",
      printTime: "~3h",
      designer: "simon.muzi (muzi.works)",
      source: "MakerWorld",
      makerworld: "https://makerworld.com/es/models/160873",
      description: "La carcasa minimal más popular para Heltec V3. Diseño dos piezas snap-fit (45.5×64.6×19.5mm, 22g). Puerto SMA, ventana OLED, cierre con tornillos M3 y soporte para baterías hasta 48mm.",
      stock: true,
      featured: true
    },
    {
      ...
      pricePen: 65,
      image: "./images/carcasas/magsafe-t114-case.jpg",
      badges: ["MagSafe", "T114", "GPS", "Magnético"],
      compatible: ["Heltec T114 (nRF52840 + SX1262)"],
      material: "PLA + Magnetos",
      color: "Blanco / Gris",
      printTime: "~5h",
      designer: "yashmulgaonkar",
      source: "MakerWorld",
      makerworld: "https://makerworld.com/es/models/2568978",
      description: "Carcasa slim para T114 con montaje magnético compatible MagSafe. Se adhiere a teléfonos, superficies metálicas y soportes magnéticos. Incluye espacio para GPS y batería. Compatible con Meshtastic y MeshCore.",
      stock: true,
      featured: false
    },
    {
      ...
      pricePen: 70,
      image: "./images/carcasas/shark-fin-case.jpg",
      badges: ["Diseño único", "Radio", "Meshtastic", "MeshCore"],
      compatible: ["Heltec V3", "Heltec V4", "XIAO nRF52840"],
      material: "PLA / PETG",
      color: "Negro",
      printTime: "~5h",
      designer: "adam.fourney",
      source: "MakerWorld",
      makerworld: "https://makerworld.com/es/models/1667585",
      description: "Enclosure con forma de aleta de tiburón para nodos Meshtastic y MeshCore. Diseño aerodinámico único que destaca sobre las carcasas rectangulares convencionales. Ideal para montaje en vehículos.",
      stock: true,
      featured: false
    },
    {
      ...
      pricePen: 95,
      image: "./images/carcasas/solar-repeater-case.jpg",
      badges: ["Solar", "T114", "MPPT", "Impermeable", "Repetidor"],
      compatible: ["Heltec T114 (nRF52840 + SX1262)"],
      material: "PETG + TPU",
      color: "Verde / Gris",
      printTime: "~9h",
      designer: "MakerWorld Community",
      source: "MakerWorld",
      makerworld: "https://makerworld.com/es/models/1416250",
      description: "Enclosure para repetidor solar permanente con panel solar integrado y soporte MPPT. Porta-baterías removibles (3 unidades), juntas TPU impermeables y montaje en poste o ménsula. Meshtastic y MeshCore.",
      stock: true,
      featured: true
    },
    {
      ...
      pricePen: 55,
      image: "./images/carcasas/dji-mini2-mount.jpg",
      badges: ["Dron", "DJI Mini 2", "Heltec V3", "Aéreo"],
      compatible: ["Heltec V3 (variante 1100mAh)"],
      material: "PLA ligero",
      color: "Negro",
      printTime: "~4h",
      designer: "RedManF150",
      source: "MakerWorld",
      makerworld: "https://makerworld.com/es/models/880577",
      description: "Montura para DJI Mini 2 que convierte el dron en un repetidor/punto de acceso aéreo Meshtastic. Diseño ultraligero de mínimo impacto en la autonomía del dron. Compatible con variante Heltec V3 de 1100mAh.",
      stock: true,
      featured: false
    },
    {
      ...
      pricePen: 45,
      image: "./images/carcasas/heltec-v4-desktop-case.jpg",
      badges: ["Desktop", "Heltec V4", "Ático", "Montaje pared"],
      compatible: ["Heltec V4 (LoRa32 V4)"],
      material: "PLA",
      color: "Blanco / Gris claro",
      printTime: "~4h",
      designer: "MakerWorld Community",
      source: "MakerWorld",
      makerworld: "https://makerworld.com/es/models/2418807",
      description: "Carcasa de escritorio o ático para Heltec V4. Alimentación por USB-C sin batería interna. Montable en pared, diseño multiparte en una sola placa de impresión. Ideal como nodo fijo en casa u oficina.",
      stock: true,
      featured: false
    },
    {
      ...
      pricePen: 55,
      image: "./images/carcasas/compact-companion-case.jpg",
      badges: ["Compacto", "EDC", "MeshCore", "Meshtastic"],
      compatible: ["XIAO nRF52840", "Wio-SX1262", "Heltec V3"],
      material: "PLA / Resina",
      color: "Morado / Negro",
      printTime: "~4h",
      designer: "MakerWorld Community",
      source: "MakerWorld",
      makerworld: "https://makerworld.com/es/models/2787675",
      description: "Nodo compacto de bolsillo para uso diario (EDC) con Meshtastic o MeshCore. Diseñado para acompañar a tu radio o teléfono principal en operaciones de red mesh. Forma ergonómica y portátil.",
      stock: true,
      featured: false
    }
  ],
